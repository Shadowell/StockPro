"""为旧策略库候选运行完整晋级回测（v3 协议）。

用法：DATABASE_URL=... venv/bin/python promote_legacy.py
"""
    ...
    for keyword in CANDIDATES:
        ...
        try:
            run = service.run({
                ...
                "run_name": f"full-legacy:{keyword}",
