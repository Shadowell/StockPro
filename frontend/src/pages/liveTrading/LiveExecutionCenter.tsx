...
function livePanelStatusFilterCountClass(_filter: LivePanelStatusFilter, active: boolean): string {
                        ...
                        return (
                          <div
                            ...
                            className={clsx(
                              ...
                              strategy.strategyId === selectedStrategyId ? 'border-yellow-400/60' : 'border-red-500/25',
                            )}
                          >
                            <div className="flex items-start justify-between gap-3">
                              <div className="min-w-0">
