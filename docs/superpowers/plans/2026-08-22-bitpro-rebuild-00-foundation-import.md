...
- 源 SHA 固定为 `aecd03f75d0ef11e18d219da97fecae9613f2a64`，StockPro 计划提交固定为
...
def test_source_manifest_uses_committed_tree_only(bitpro_repo):
    result = verify_source(bitpro_repo, "aecd03f75d0ef11e18d219da97fecae9613f2a64")
    assert result["head"] == "aecd03f75d0ef11e18d219da97fecae9613f2a64"
