...
def test_live_execution_panel_status_filter_uses_uniform_yellow_selection():
    page = _read("frontend/src/pages/liveTrading/LiveExecutionCenter.tsx")

    assert "function livePanelStatusFilterButtonClass(filter: LivePanelStatusFilter, active: boolean): string" in page
    assert "function livePanelStatusFilterCountClass(_filter: LivePanelStatusFilter, active: boolean): string" in page
    ...
    assert "return SELECTED_SEGMENT_CLASS" in page
    assert "return SELECTED_SEGMENT_COUNT_CLASS" in page
